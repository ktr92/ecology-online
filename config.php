...
define("TIT1", '«Экостандарт»');

//параметры подключения к БД
define("DB_URL", 'mysqli://elvirawf_eco:zPmV*e3h@localhost/elvirawf_eco');
